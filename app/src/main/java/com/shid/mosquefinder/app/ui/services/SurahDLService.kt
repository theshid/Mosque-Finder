...
import com.shid.mosquefinder.app.ui.services.downloadUtil.NotificationHelper
import com.shid.mosquefinder.app.ui.services.downloadUtil.NotificationHelper.Companion.NOTIFICATION_ID
...
class SurahDLService : Service() {
    ...
    private fun downloadMedia(url: String, nameFile: String) {
        ...
        downloadTask.progress()
            .onEach { progress ->
                helper.notificationBuilder.setProgress(100, progress.percent().toInt(), false)
