...
object TimeUtil {
    ...
    val Timestamp.fullDate
        get() : String = DateFormat.format("EEE, dd MMMM yyyy", this.toDate()).toString()
    val Timestamp.dayOfWeek get() : String = DateFormat.format("EEE", this.toDate()).toString()
    val Timestamp.partialDate
        get() : String = DateFormat.format("EEE, dd MMMM", this.toDate()).toString()
    val Timestamp.all
        get() : String = DateFormat.format(
            "EEEE, dd MMMM yyy - hh:mm a",
            this.toDate()
        ).toString()
    val Timestamp.montYear get() : String = DateFormat.format("MMM, yyyy", this.toDate()).toString()
    val Timestamp.formatDate
        get() : String = DateFormat.format("dd-MM-yyyy", this.toDate()).toString()
